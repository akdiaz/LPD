...
class LinesTest(unittest.TestCase):
    ...
    def test_match_lines(self):
        ...
        potential_lines = [['13COv=0', 'J=3-2,F=5/2-5/2', 330587.8671, 330587.8671], ['13COv=0', 'J=3-2,F=7/2-5/2', 330587.9816, 330587.98160]]
        detected_lines_frequency = [330587.8671, 330588.8671]
        tolerance = 0.01
        actual_lines = check_line.match_lines(potential_lines, detected_lines_frequency, tolerance)
        expected_output = [[0, '13COv=0', 'J=3-2,F=5/2-5/2', 330587.8671, 330587.8671], [1, "U", "U", "0", "0"]]
