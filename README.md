...
`MEMOIR` has two subcommands: `extract`, to extract a spectrum from a cube, and `identify`, to detect and identify the lines in a spectrum.
...
subcommands:
  ...
  {extract,identify}  type memoir <<subcommand>> -h to get additional help
```
