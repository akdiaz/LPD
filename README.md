...
```
usage: memoir identify [-h] [-s SPECTRUM_FILE_NAME [SPECTRUM_FILE_NAME ...]]
                       [-l KNOWN_LINES_FILE_NAME] [-o OUTPUT] [--snr SNR]
                       [-w LINE_WIDTH] [-t FREQUENCY_TOLERANCE] [--vlsr VLSR]

detects lines in a spectrum (provided by -s) and identifies them by comparing
their frequencies with those in a known-lines file (provided by -l). Writes to
disks a file and plot(s) with the relevant info in the folder <<output>>.
...
optional arguments:
  ...
  -l KNOWN_LINES_FILE_NAME, --known_lines_file_name KNOWN_LINES_FILE_NAME
                        ...
                        lines. If not specified, use memoir's built-in one.
  -o OUTPUT, --output OUTPUT
                        Name of the output folder.
  --snr SNR             Signal-to-noise ratio. Only peaks with flux higher
                        than <<SNR>> will be returned
  -w LINE_WIDTH, --line_width LINE_WIDTH
                        ...
                        the one with higher flux will be returned.
  -t FREQUENCY_TOLERANCE, --frequency_tolerance FREQUENCY_TOLERANCE
                        ...
                        not, will remain unidentified (U).
